...
If you export `setSettings` function from your plugin, it will be called every time settings are changed or on plugin load, with changed values ([example](https://github.com/keeweb/keeweb/blob/develop/plugins/examples/settings/plugin.js#L29)).
