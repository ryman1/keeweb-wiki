...
Don't want to install it? [Here](https://github.com/keeweb/keeweb/blob/develop/plugins/plugin-control/keeweb-plugin.js)'s the script, you can just download it.
