...
Auto Type module has been re-written in KeeWeb v1.17, which means it will have some issues. Please forgive us this inconvenience, it should become even more stable in future releases. Additionally, it's extracted as [its own library](https://github.com/antelle/keyboard-auto-type), which should help developers building auto-type in their apps too.
