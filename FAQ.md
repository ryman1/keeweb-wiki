...
A: [Yes](https://github.com/keeweb/keeweb/issues/19#issuecomment-154710697) but you have to create your own Dropbox app.  
...
Q: The feature I want is very strange, or useful for me only, or conflicts with author's product vision or roadmap, and I'm ready to pay for it (the price will be high; expected requests are corporate features, enterprise customisation, private installations an so on, and not _plz make this feature faster for a cup of coffee_).  
