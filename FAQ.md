...
A: Yes, in April-May 2020 [Hackmanit](https://www.hackmanit.de/) conducted a penetration test of KeeWeb during their [Pro Bono](https://www.hackmanit.de/en/blog-en/80-pro-bono-penetration-test) 2020 program. All the vulnerabilities have been fixed in v1.4.2, the report can be found [here](https://www.hackmanit.de/images/download/2020-04_Open_Penetration_Tests_KeeWeb.pdf).  
