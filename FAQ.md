...
A: KeeWeb is made in Amsterdam, the Netherlands. The source code is hosted on GitHub in the U.S. Website content is stored on Google Cloud in multiple locations in the EU (Finland, Belgium, London, Frankfurt, Netherlands, Zürich) and delivered through CloudFlare content delivery network. Domain names are registered in the U.S.  
