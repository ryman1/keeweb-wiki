...
The app is bundled with WebPack and built with Grunt. While it's so 2010s to use Grunt nowadays, it's still far ahead of using npm scripts and perfectly solves the task of doing different actions with JS. However it't not used for any of web bundle building tasks, this part is completely moved to WebPack.
