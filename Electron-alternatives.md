...
Right now the decision is not to migrate, KeeWeb continues using Electron. Having a stable app and better support for older operating systems is more important rather than extra 70 MB or memory and 100 MB of filesystem space.